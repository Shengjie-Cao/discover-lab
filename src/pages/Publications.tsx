  ...
  return (
    <div className="section-padding">
      <div className="container-wide mx-auto">
        <SectionHeading title="Publications" subtitle="A comprehensive list of our research outputs." />
        ...
        {grouped.map(([year, pubs]) => (
          <section key={year} className="mb-10">
            <h3 className="font-heading text-2xl font-bold text-foreground mb-4 border-b border-border pb-2">
              {year}
            </h3>
        ...
        {filtered.length === 0 && (
          <p className="text-center text-muted-foreground py-12">No publications match the selected filters.</p>
        )}
      </div>
